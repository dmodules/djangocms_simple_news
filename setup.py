...
def get_version(*file_paths):
    """Retrieves the version from djangocms_simple_news/__init__.py"""
...
version = get_version("djangocms_simple_news", "__init__.py")
...
setup(
    ...
    version=version,
    description="""DjangoCMS simple news app.""",
